...
void main() {
  ...
  /// (화면 960에서 여백(fitAllPadding, 7단계 카드 그룹화로 80이 됨)을
  /// 빼면 800, 범위가 1600이므로 절반. 세로도 600에서 여백을 빼면 440,
  /// 범위가 880이므로 절반) 계산이 떨어지는 숫자라 기댓값을 적기 쉽습니다.
  const Rect testContent = Rect.fromLTWH(0, 0, 1600, 880);
